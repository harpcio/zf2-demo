...
class BetweenCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var BetweenCommand
     */
    ...
    {
        $this->testedObject = new BetweenCommand();
    }
    ...
    public function testExecute()
    {
        ...
        $criteria = new Criteria(Criteria::TYPE_CONDITION_BETWEEN, 'columnName', ['left', 'right']);
