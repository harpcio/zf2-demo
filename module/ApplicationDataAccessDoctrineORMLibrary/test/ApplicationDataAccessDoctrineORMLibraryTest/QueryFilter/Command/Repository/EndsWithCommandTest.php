...
use ApplicationDataAccessDoctrineORMLibrary\QueryFilter\Command\Repository\EndsWithCommand;
use BusinessLogicLibrary\QueryFilter\Criteria;
use Doctrine\DBAL\Query\QueryBuilder;
use Doctrine\ORM\Query\Expr;
use PHPUnit_Framework_MockObject_MockObject as MockObject;

class EndsWithCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var EndsWithCommand
     */
    ...
    {
        $this->testedObject = new EndsWithCommand();
    }
    ...
    public function testExecute()
    {
        ...
        $criteria = new Criteria(Criteria::TYPE_CONDITION_ENDS_WITH, 'columnName', 'something');
