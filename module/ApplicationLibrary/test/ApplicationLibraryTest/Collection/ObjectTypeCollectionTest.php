...
namespace ApplicationLibraryTest\Collection;

use ApplicationLibraryTest\Collection\Provider;
...
class ObjectTypeCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOffsetSet_WithInvalidObject()
    {
        $this->setExpectedException(
            ...
            'Illegal class name, expected: ApplicationLibraryTest\\Collection\\Provider\\MyClass, got ApplicationLibraryTest\\Collection\\Provider\\HisClass'
        );
